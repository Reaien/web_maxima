...
import { DriveMachineIcon } from "../icons/DriveMachineIcon";
import { TendencyIcon } from "../icons/TendencyIcon";
    ...
    <>
      ...
      <section className="grid md:grid-cols-2  animate-fade md:animate-once md:animate-duration-[5000ms]">
        <div className="flex justify-center items-center  flex-col ">
          ...
          <p className="w-72">
            Contamos con mas de 100 programas de formación enfocados
            específicamente en las siguientes áreas especializadas.
          </p>
        </div>
        ...
        <section className="grid md:grid-cols-3 text-center mb-20 md:-ml-48">
          <div className="mt-10  md:px-16 px-10">
            ...
            <p className=" text-slate-700 font-overpass mt-4 px-2 animate-fade md:animate-once md:animate-duration-[5000ms]">
              ...
              Herramientas energizadas, Espacios confinados, Montaje de
              Andamios, Postación eléctrica, Sustancias Peligrosas, ICAM, EVITA
              y más.
            </p>
          </div>
          <div className="mx-auto mt-10 md:animate-fade-up md:animate-once md:animate-duration-[3000ms]  px-16">
            <div className="w-[60px] h-[60px] bg-emerald-500 shadow-xl rounded-2xl flex items-center border border-slate-950/5 mx-auto animate-fade md:animate-once md:animate-duration-[3000ms]">
              <EmergencyIcon className="mx-auto w-[60px] h-[60px] text-white" />
            </div>
          ...
          <div className="mx-auto mt-10 animate-fade animate-once  px-16">
            <div className="w-[60px] h-[60px] bg-blue-500 shadow-xl rounded-2xl flex items-center border border-slate-950/5 mx-auto animate-fade-up md:animate-once md:animate-duration-[4000ms]">
              <HealthIcon className="mx-auto w-[60px] h-[60px] text-white" />
            </div>
          ...
          <div className="mx-auto mt-10 animate-fade animate-once  px-16">
            <div className="w-[60px] h-[60px] bg-red-600 shadow-xl rounded-2xl flex items-center border border-slate-950/5 mx-auto animate-fade-up md:animate-once md:animate-duration-[4000ms]">
              <DriveMachineIcon className="mx-auto w-[60px] h-[60px] text-white" />
            </div>
            <p className="text-4xl font-bold text-slate-700 font-overpass mt-4 animate-fade-up md:animate-once md:animate-duration-[5000ms]">
          ...
          <div className="mx-auto mt-10 animate-fade animate-once  px-16">
            <div className="w-[60px] h-[60px] bg-violet-500 shadow-xl rounded-2xl flex items-center border border-slate-950/5 mx-auto animate-fade-up md:animate-once md:animate-duration-[4000ms]">
            ...
            <p className=" text-slate-700 font-overpass mt-4 px-2 animate-fade-up md:animate-once  md:animate-duration-[5000ms]">
              Normas NFPA todas sus series, Responsabilidad Civil Penal y
              Laboral ante Accidentes del trabajo y Enfermedades Profesionales,
              Normas ISO.
            </p>
          </div>
          <div className="mx-auto mt-10 animate-fade animate-once  px-16">
            <div className="w-[60px] h-[60px] bg-pink-500 shadow-xl rounded-2xl flex items-center border border-slate-950/5 mx-auto animate-fade-up md:animate-once md:animate-duration-[4000ms]">
              <TendencyIcon className="mx-auto w-[40px] h-[40px] text-white" />
            </div>
            <p className="text-4xl font-bold text-slate-700 font-overpass mt-4 animate-fade-up md:animate-once md:animate-duration-[5000ms]">
              Tendencias
            </p>
